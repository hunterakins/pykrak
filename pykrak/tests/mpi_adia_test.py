...
def downslope_test():
    ...
    if rank == 0:
        ...
        # now use KRAKEN
        name = 'at_files/adia_pekeris_test.env'
        model='kraken'
        ...
        # run kraken
        import os
        os.system('cd at_files && kraken.exe adia_pekeris_test')
        ...
        write_fieldflp('at_files/adia_pekeris_test.flp', 'RA', pos_field, **kwargs)
        os.system('cd at_files && field.exe adia_pekeris_test')


        [ PlotTitle, PlotType, freqVec, atten, pos, pressure ] = read_shd('at_files/adia_pekeris_test.shd')
