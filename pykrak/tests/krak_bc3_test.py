...
z_arr = np.concatenate((np.linspace(0.0, 10.0, 101), np.linspace(10.0, 20.0, 101), np.linspace(20.0, 25.0, 501)))
ind_arr = np.array([0, 101, 202])
h_arr = np.array([z_arr[ind_arr[x] + 1] - z_arr[ind_arr[x]] for x in range(3)])
print(h_arr)
freq = 1500.0
omega2 = (2*np.pi*freq)**2
cp_arr = np.concatenate((1500.0 * np.ones(101), 1550.0 * np.ones(101), 1600.0 * np.ones(501)))
cs_arr = np.concatenate((0.0 * np.ones(101), 0.0 * np.ones(101), 300.0 * np.ones(501)))
rho_arr = np.concatenate((1.0 * np.ones(101), 1.2 * np.ones(101), 1.5 * np.ones(501)))
alpha_arr = np.concatenate((0.0* np.ones(101), 0.3* np.ones(101), 0.2 * np.ones(501)))
alphas_arr = np.concatenate((0.0* np.ones(101), 0.0* np.ones(101), 1.0 * np.ones(501)))
