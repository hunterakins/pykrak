...
modeCount = 0
fbott, gbott, iPower, modeCount = kr.get_bc_impedance(x, omega2, False, cp_bott, cs_bott, rho_bott, 
...
print('f, g', f, g)
ftop, gtop, iPower, modeCount = kr.get_bc_impedance(x, omega2, True, cp_top, cs_top, rho_top, 
                                h_arr, ind_arr, z_arr, b1, b2, b3, b4, rho_arr, 
                                first_acoustic, last_acoustic, modeCount)
print('ftop, gtop')
print(ftop, gtop)
